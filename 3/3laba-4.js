...
divFirst.textContent = `${customers[0].f_name} ${customers[0].l_name}`

const divSecond = document.createElement('div');
divSecond.className = 'card';
divSecond.textContent = `Возраст: ${customers[0].age}, Семейное положение: ${customers[0].married}`;

section.appendChild(divFirst);
section.appendChild(divSecond);
